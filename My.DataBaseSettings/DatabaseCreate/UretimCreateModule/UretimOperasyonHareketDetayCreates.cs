...
{
  public static  class UretimOperasyonHareketDetayCreates
    {
        private const string _tabloAdi = "UretimOperasyonHareketDetay";
        public static void UretimOperasyonHareketDetayCreate(this List<string> list)
        {
            list.CreateTable("Id");
            list.CreateColumns();
        }
        ...
        {
            list.Add(TableCreate.SqlSutun(_tabloAdi, "Turu", TableCreate.String(50), ""));
