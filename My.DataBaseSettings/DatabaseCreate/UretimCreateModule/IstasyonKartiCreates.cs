...
{
    public static class IstasyonKartiCreates
    {
        private const string _tabloAdi = "IstasyonKarti";
        public static void IstasyonKartiCreate(this List<string> list)
        {
            list.CreateTable("Id");
            list.CreateColumns();
        ...
        static void CreateColumns(this List<string> list)
        {
            ...
            list.Add(TableCreate.SqlSutun(_tabloAdi, "Operasyon", TableCreate.VarChar(50), ""));
            ...
            list.Add(TableCreate.SqlSutun(_tabloAdi, "Yazdirilmali", TableCreate.SmallInt(), ""));
            list.Add(TableCreate.SqlSutun(_tabloAdi, "KaliteKontrol", TableCreate.SmallInt(), ""));
            list.Add(TableCreate.SqlSutun(_tabloAdi, "FasonCariKodu", TableCreate.VarChar(50), ""));
            list.Add(TableCreate.SqlSutun(_tabloAdi, "FasonCariAdi", TableCreate.VarChar(150), ""));
