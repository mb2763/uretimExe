...
namespace My.DatabaseSettings.DatabaseCreate.UretimCreateModule {
    public static class UretimTalepCreates {
        private const string _tabloAdi = "UretimTalep";
        private const string _idAdi = "UrtTlpId";
        public static void UretimTalepCreate(this List<string> list) {
            list.CreateTable();
            list.CreateColumns();
        }
